import { ComponentType, DragEvent, ReactNode, SVGProps, useState } from "react";
...
import { cn, resizeImage, VariantProps } from "@ziron/utils";

type Icon = TablerIcon | LucideIcon | ComponentType<SVGProps<SVGSVGElement>>;
