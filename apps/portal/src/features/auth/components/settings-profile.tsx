...
import { Field, FieldContent, FieldDescription, FieldError, FieldLabel } from "@ziron/ui/components/field";
...
export default function SettingsProfile({
  ...
  const handleAvatarRemove = async () => {
    if (onAvatarRemove) {
      ...
      try {
        ...
        setErrors({
          avatar: error instanceof Error ? error.message : "Failed to remove avatar",
        });
      } finally {
        setIsUploadingAvatar(false);
      }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setErrors({
        _general: error instanceof Error ? error.message : "Failed to save profile",
      });
    } finally {
      setIsSaving(false);
    }
  ...
  const handleEmailChange = async () => {
    ...
    try {
      await onEmailChange?.(emailChangeData.newEmail, emailChangeData.currentPassword);
      ...
      setErrors({
        emailChange: error instanceof Error ? error.message : "Failed to change email",
      });
    } finally {
      ...
      <CardHeader>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex min-w-0 flex-1 flex-col gap-2">
            ...
            <CardDescription className="wrap-break-word">Manage your profile information and avatar</CardDescription>
          </div>
          <div className="flex shrink-0 gap-2">
            <Button className="w-full sm:w-auto" disabled={isSaving} onClick={handleSave} type="button">
              {isSaving ? (
                <>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <div
                className={cn(
                  ...
                  isUploadingAvatar ? "border-primary bg-primary/5" : "border-muted bg-muted/30 hover:border-primary/50"
                )}
              ...
              <div className="flex flex-1 flex-col gap-2">
                <div className="flex flex-col gap-2 sm:flex-row">
                  <Button onClick={handleAvatarClick} type="button" variant="outline">
                    <Camera className="size-4" />
                    {avatarPreview ? "Change Photo" : "Upload Photo"}
                  </Button>
                  {avatarPreview && (
                    <Button onClick={handleAvatarRemove} type="button" variant="outline">
                      <X className="size-4" />
                      Remove
                    </Button>
                  )}
              ...
              <div className="flex flex-col gap-4 rounded-lg border bg-muted/30 p-4">
                <Field>
                  ...
                  <FieldContent>
                    ...
                    {errors.newEmail && <FieldError>{errors.newEmail}</FieldError>}
                  </FieldContent>
                </Field>
                ...
                <Field>
                  ...
                  <FieldContent>
                    ...
                    {errors.emailChange && <FieldError>{errors.emailChange}</FieldError>}
                  </FieldContent>
                </Field>
