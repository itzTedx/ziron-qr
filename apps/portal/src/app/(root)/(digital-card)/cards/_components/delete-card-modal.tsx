		...
		<>
			<div className="space-y-2 border-neutral-200 border-b p-4 sm:p-6">
				<DialogHeader>
					...
					<DialogDescription className="sr-only">
						Are you sure you want to delete the following {pluralize("card", cards.length)}? This action
						cannot be undone.
					</DialogDescription>
				</DialogHeader>
			</div>
			...
			<div className="bg-neutral-50 p-4 sm:p-6">
				...
				<p className="mt-2 font-semibold text-neutral-900 text-sm">
					...
					{cards.length > 1 ? "them" : "it"} and all associated data, including contact information, links,
					media files, and analytics.
				</p>
