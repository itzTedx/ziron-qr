...
export function PaginationControls({
  ...
  return (
    <div className={cn("flex items-center justify-between gap-2 text-faded-foreground text-sm leading-6", className)}>
      ...
      <div className="flex items-center gap-2">
        ...
        <Button
          className="bg-faded"
          disabled={!totalCount || (pagination.pageIndex - 1) * pagination.pageSize + pagination.pageSize >= totalCount}
          onClick={() =>
            setPagination({
              ...pagination,
              pageIndex: pagination.pageIndex + 1,
