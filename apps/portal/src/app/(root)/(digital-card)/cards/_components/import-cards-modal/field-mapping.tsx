              ...
              <Popover onOpenChange={setIsOpen} open={isOpen}>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    variant="outline"
                  >
                    <LoadingSwap className="flex w-full grow items-center justify-between gap-1" isLoading={isLoading}>
                ...
                <PopoverContent align="end" className="w-full p-2 md:w-48">
                  {[...(fileColumns || []), ...(fieldValue && !required ? ["None"] : [])]?.map((column) => {
                    ...
                    return (
                      ...
                      >
                        <IconMenu icon={<Icon className="size-4 flex-none" />} text={column} />
            ...
            <div className="block px-4 py-3 text-sm">
              ...
              <ul className="mt-0.5">
                {examples
                  ...
                  .map((example, idx) => (
                    <li className="block text-neutral-500 text-xs leading-tight" key={example + idx + field}>
                      <span className="translate-y-1 text-base text-neutral-600">&bull;</span> {example}
                    </li>
                  ))}
              </ul>
            </div>
