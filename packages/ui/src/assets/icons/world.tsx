...
export const IconWorldPointer = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg {...props} className="size-3.5" height="18" viewBox="0 0 18 18" width="18" xmlns="http://www.w3.org/2000/svg">
      <g fill="currentColor">
        <path
