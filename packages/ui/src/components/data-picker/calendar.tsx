    ...
    <DayPicker
      ...
      components={{
        ...
        MonthCaption: ({ children, ...props }) => {
          ...
          const { numberOfMonths = 1, startMonth: dayPickerStartMonth, endMonth: dayPickerEndMonth } = dayPickerProps;
                ...
                {showYearNavigation && !hidePreviousButton && (
                  <NavigationButton
                    ...
                    disabled={
                      disableNavigation ||
                      !previousMonth ||
                      (startConstraint && addYears(currentMonth, -1).getTime() < startConstraint.getTime())
                    }
                    icon={ChevronsLeft}
                ...
                {showYearNavigation && !hideNextButton && (
                  <NavigationButton
                    ...
                    disabled={
                      disableNavigation ||
                      !nextMonth ||
                      (endConstraint && addYears(currentMonth, 1).getTime() > endConstraint.getTime())
                    }
                    icon={ChevronsRight}
